...
def app():
    ...
    with tab1:  
        ...
        html_table = create_html_table_with_download(formatted_cm_train, "Development_Data.xlsx", image_path)
        st.markdown(html_table, unsafe_allow_html=True)
        ...
        strength_statistics = {
            'Performance Metrics':['KS','Precision','F1-Score','Recall','Gini','ROC AUC score'],
            'Development Data (Train Data)':[ks_statistic_train,precision_train,f1_train,recall_train,gini_train,roc_auc],
            'Monitoring Data (Test Data)': [ks_statistic_test,precision_test,f1_test,recall_test,gini_test,roc_auc_test]
        }
    ...
    with tab2:
        ...
        def plot_roc_curve(fpr, tpr):
            ...
            fig.add_trace(go.Scatter(
                ...
                mode='none',
                fillcolor='rgba(31, 119, 180, 0.3)',  # Color similar to your original code

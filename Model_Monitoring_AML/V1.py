...
import EDA, Feature_eng, Model_Monitoring, Cross_val
    ...
    def run(self):
        with st.sidebar:
            app = option_menu(
                ...
                options=['Overview', 'Data Overview', 'EDA', 'Feature Engineering', 'Model Monitoring', 'Cross Validation'],
                icons=['cast', 'book', 'bar-chart', 'tools', 'graph-up', 'shuffle'],
                menu_icon='bank',
                default_index=0,
                styles={
                "container": {"padding": "0px", "background-color": "rgba(190, 215, 252, 0.38)", "border": "1px solid #A9A9A9", "border-radius": "7px",},
...
if __name__ == "__main__":
    ...
    multi_app.add_app("Feature Engineering", Feature_eng)
    multi_app.add_app("Model Monitoring", Model_Monitoring)
    multi_app.add_app("Cross Validation", Cross_val)
